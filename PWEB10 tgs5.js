...
document.writeln('</tr>');
document.writeln('<tr>');
document.writeln('<td colspan="3">Total Harga Semua Barang</td><td>' + ((tugas5[0].harga * tugas5[0].jumlah) + (tugas5[1].harga * tugas5[1].jumlah) + (tugas5[2].harga * tugas5[2].jumlah)) + '</td>');
document.writeln('</tr>');
document.writeln("<td colspan='2'></td><td colspan='2'><button onclick=\"bayar()\">Bayar</button></td>");
document.writeln("</tr>");
document.writeln("<tr>");
document.writeln("<td colspan='4'>Muhammad Hariri</td>");
document.writeln("</tr>");
